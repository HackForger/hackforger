	...
	w := &webhook.Webhook{
		...
		HookEvent: &webhook_module.HookEvent{
			...
			HookEvents: webhook_module.HookEvents{
				...
				HackathonCreated:         util.SliceContainsString(form.Events, string(webhook_module.HookEventHackathonCreated), true),
				HackathonStatusChanged:   util.SliceContainsString(form.Events, string(webhook_module.HookEventHackathonStatusChanged), true),
				HackathonSubmission:      util.SliceContainsString(form.Events, string(webhook_module.HookEventHackathonSubmission), true),
				HackathonScored:          util.SliceContainsString(form.Events, string(webhook_module.HookEventHackathonScored), true),
				HackathonFinalized:       util.SliceContainsString(form.Events, string(webhook_module.HookEventHackathonFinalized), true),
				BountyCreated:            util.SliceContainsString(form.Events, string(webhook_module.HookEventBountyCreated), true),
				BountyApplication:        util.SliceContainsString(form.Events, string(webhook_module.HookEventBountyApplication), true),
				BountyClaimed:            util.SliceContainsString(form.Events, string(webhook_module.HookEventBountyClaimed), true),
				BountyCompleted:          util.SliceContainsString(form.Events, string(webhook_module.HookEventBountyCompleted), true),
				BountyPaid:               util.SliceContainsString(form.Events, string(webhook_module.HookEventBountyPaid), true),
				BountyWinners:            util.SliceContainsString(form.Events, string(webhook_module.HookEventBountyWinners), true),
				BountyExpired:            util.SliceContainsString(form.Events, string(webhook_module.HookEventBountyExpired), true),
				BountyCancelled:          util.SliceContainsString(form.Events, string(webhook_module.HookEventBountyCancelled), true),
				GrantRoundCreated:        util.SliceContainsString(form.Events, string(webhook_module.HookEventGrantRoundCreated), true),
				GrantRoundOpened:         util.SliceContainsString(form.Events, string(webhook_module.HookEventGrantRoundOpened), true),
				GrantProjectSubmitted:    util.SliceContainsString(form.Events, string(webhook_module.HookEventGrantProjectSubmitted), true),
				GrantAwarded:             util.SliceContainsString(form.Events, string(webhook_module.HookEventGrantAwarded), true),
				GrantRoundFinalized:      util.SliceContainsString(form.Events, string(webhook_module.HookEventGrantRoundFinalized), true),
				CreditsDeposited:         util.SliceContainsString(form.Events, string(webhook_module.HookEventCreditsDeposited), true),
				CreditsRedeemed:          util.SliceContainsString(form.Events, string(webhook_module.HookEventCreditsRedeemed), true),
			},
