...
func ParseHookEvent(form forms.WebhookCoreForm) *webhook_module.HookEvent {
	return &webhook_module.HookEvent{
		...
		HookEvents: webhook_module.HookEvents{
			...
			HackathonCreated:         form.HackathonCreated,
			HackathonStatusChanged:   form.HackathonStatusChanged,
			HackathonSubmission:      form.HackathonSubmission,
			HackathonScored:          form.HackathonScored,
			HackathonFinalized:       form.HackathonFinalized,
			BountyCreated:            form.BountyCreated,
			BountyApplication:        form.BountyApplication,
			BountyClaimed:            form.BountyClaimed,
			BountyCompleted:          form.BountyCompleted,
			BountyPaid:               form.BountyPaid,
			BountyWinners:            form.BountyWinners,
			BountyExpired:            form.BountyExpired,
			BountyCancelled:          form.BountyCancelled,
			GrantRoundCreated:        form.GrantRoundCreated,
			GrantRoundOpened:         form.GrantRoundOpened,
			GrantProjectSubmitted:    form.GrantProjectSubmitted,
			GrantAwarded:             form.GrantAwarded,
			GrantRoundFinalized:      form.GrantRoundFinalized,
			CreditsDeposited:         form.CreditsDeposited,
			CreditsRedeemed:          form.CreditsRedeemed,
		},
